                ...
                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="product-card bg-white rounded-xl overflow-hidden shadow-sm transition-transform duration-300">
                        ...
                        <div class="p-4 text-left">
                            ...
                            <p class="text-gray-700 text-sm"><?php echo e($menu->deskripsi); ?></p>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.mainlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\jap_j\OneDrive\ドキュメント\vscode\webdev_afl3\resources\views/home.blade.php ENDPATH**/ ?>