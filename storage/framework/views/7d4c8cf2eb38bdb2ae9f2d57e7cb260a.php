<?php $__env->startSection('title', 'Kontak - Alvca Matcha'); ?>
        ...
        <div class="max-w-6xl mx-auto px-4">
            ...
            <div class="mt-12 bg-white rounded-2xl shadow-md overflow-hidden">
                <div class="bg-green-100 p-6 text-center">
                    <h3 class="text-2xl font-bold text-green-800 mb-2">Lokasi Kami</h3>
...
<?php echo $__env->make('layouts.mainlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/jj/Herd/webdev_afl3-1/resources/views/contact.blade.php ENDPATH**/ ?>