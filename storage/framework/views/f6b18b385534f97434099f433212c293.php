                            ...
                            <tbody class="divide-y divide-gray-200">
                                ...
                                <?php $__currentLoopData = $keranjang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr class="hover:bg-green-50 transition-colors">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <form action="<?php echo e(route('keranjang.update', $item->id)); ?>" method="POST" class="inline-flex items-center gap-2">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.mainlayout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/jj/Herd/webdev_afl3-1/resources/views/keranjang/index.blade.php ENDPATH**/ ?>