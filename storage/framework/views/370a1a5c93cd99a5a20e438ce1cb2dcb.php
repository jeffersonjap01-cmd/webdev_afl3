            ...
            <?php if($keranjang->count() > 0): ?>
                ...
                <div class="mt-6 bg-white rounded-2xl shadow-md p-8">
                    ...
                    <div class="mb-6">
                        ...
                        <?php if(session('promo_applied')): ?>
                            <?php $promo = session('promo_applied'); ?>
                            <div class="mt-2 bg-green-100 border border-green-400 text-green-700 px-4 py-2 rounded">
                                Promo diterapkan: <?php echo e($promo->nama_promo); ?>
                    ...
                    <form action="<?php echo e(route('payment.cart')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <?php if(session('promo_applied')): ?>
                            <input type="hidden" name="promo_id" value="<?php echo e(session('promo_applied')->id); ?>">
                        <?php endif; ?>
