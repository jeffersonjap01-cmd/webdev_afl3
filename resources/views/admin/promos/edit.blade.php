...
@section('content')
    ...
    <section class="py-8 text-center bg-gradient-to-b from-green-50 to-green-100 border-b border-green-200">
        <div class="max-w-6xl mx-auto px-4">
            <h1 class="text-4xl font-bold text-green-800 mb-3">Edit Promo</h1>
            <p class="text-gray-700 text-lg">
                Perbarui informasi promo di bawah ini.
            </p>
        </div>
    </section>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="deskripsi" 
                                      name="deskripsi" 
                                      rows="3"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">{{ old('deskripsi', $promo->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       id="diskon_nominal" 
                                       name="diskon_nominal" 
                                       value="{{ old('diskon_nominal', $promo->diskon_nominal) }}"
                                       min="0"
                                       step="100"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('tanggal_berakhir', \Carbon\Carbon::parse($promo->tanggal_berakhir)->format('Y-m-d')) }}"
                                       required
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="number" 
                                       id="min_pembelian" 
                                       name="min_pembelian" 
                                       value="{{ old('min_pembelian', $promo->min_pembelian) }}"
                                       min="0"
                                       step="100"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                                @error('min_pembelian')
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       id="max_diskon" 
                                       name="max_diskon" 
                                       value="{{ old('max_diskon', $promo->max_diskon) }}"
                                       min="0"
                                       step="100"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500">
                                @error('max_diskon')
                        ...
                        <div>
                            ...
                            <select name="status" id="status" required
                                ...
                                <option value="tidak_aktif" {{ old('status', $promo->status) === 'tidak_aktif' ? 'selected' : '' }}>Tidak Aktif</option>
                            </select>
                            @error('status')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
